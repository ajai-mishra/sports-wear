  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Update your own name and phone number.</p>
      </div>
          ...
          {isLoading || !profile ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
              ...
              <FormField
                label="Email"
                htmlFor="email"
                description="Email can't be changed here yet — contact a Super Admin if you need it updated."
              >
              ...
              <FormField label="Role" htmlFor="role">
                <div id="role">
                  <Badge variant="outline">{profile.role.replaceAll("_", " ")}</Badge>
                </div>
              </FormField>
